-- ============================================================================
-- FINDIN - SUPABASE MINIMAL SETUP (PostgreSQL)
-- ============================================================================
-- Version minimaliste - Exécute étape par étape dans Supabase SQL Editor
-- IMPORTANT: Copie-colle ET EXÉCUTE CHAQUE SECTION SÉPARÉMENT
-- ============================================================================

-- ============================================================================
-- SECTION 1: NETTOYAGE (Exécute d'abord)
-- ============================================================================

BEGIN;

DROP TRIGGER IF EXISTS documents_update_modifie_le ON documents CASCADE;
DROP TRIGGER IF EXISTS projets_update_modifie_le ON projets CASCADE;
DROP TRIGGER IF EXISTS utilisateurs_update_modifie_le ON utilisateurs CASCADE;
...
-- ============================================================================
-- SECTION 2: CRÉER LES TABLES (Exécute ensuite)
-- ============================================================================
...
-- ============================================================================
-- SECTION 3: CRÉER LES INDEXES (Exécute ensuite)
-- ============================================================================
...
-- ============================================================================
-- SECTION 4: CRÉER LES TRIGGERS (Exécute ensuite)
-- ============================================================================
...
-- ============================================================================
-- SECTION 5: INSÉRER LES DONNÉES (Exécute en dernier)
-- ============================================================================
...
-- ============================================================================
-- SECTION 6: VÉRIFICATION (Exécute pour tester)
-- ============================================================================

SELECT tablename FROM pg_tables WHERE schemaname = 'public' ORDER BY tablename;
SELECT COUNT(*) as utilisateurs_count FROM utilisateurs;
SELECT COUNT(*) as competences_count FROM competences;
